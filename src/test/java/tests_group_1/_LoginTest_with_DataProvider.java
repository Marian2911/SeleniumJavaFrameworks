...
public class _LoginTest_with_DataProvider extends Base {
	...
	public void browserOpen() throws InterruptedException, IOException {
		log = LogManager.getLogger(_LoginTest_with_DataProvider.class.getName());       // creare object "log" de tip "Logger" (import from "import org.apache.logging.log4j.LogManager;") pentru mesaje de informare.
